      ...
      <div className="mt-6 flex flex-1 flex-col justify-between">
        <nav className="-mx-3 space-y-6 ">
          <div className="space-y-3 ">
            ...
            <div className="flex mt-5 transform items-center rounded-lg px-3 py-2 text-gray-600 transition-colors duration-300 hover:bg-gray-100 hover:text-gray-700">
              <Newspaper className="h-5 w-5" aria-hidden="true" />
              <Link to="/">
                <span className="mx-2 text-sm font-medium">Vidoes</span>
              </Link>
            </div>
